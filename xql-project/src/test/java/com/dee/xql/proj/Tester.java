...
//		System.out.println(JSON.toJSONString(djService.readDJMpp(fileName, 0L)));
	...
	@Test
	public void testXQLResource() {
		String file = "C:" + File.separator + "Users" + File.separator + "26603" + File.separator + "Desktop"
				+ File.separator + "新千里资源库.mpp";
		mppService.saveData(file, ProjectFileType.MPP_RESOURCE, 101L);
	}

	@Test
	public void testProjPlan() {
		String name = "2018090889B-黑龙江省佳木斯市向阳区-测试一路测试-设计.mpp";
		String file = "C:" + File.separator + "Users" + File.separator + "26603" + File.separator + "Desktop"
				+ File.separator + name;
		mppService.saveData(file, ProjectFileType.MPP_TASK, 101L);
	}
}
